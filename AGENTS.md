...
The command-line scripts (`makeartisatomicfiles`, `makerecombratefile`, `makechargetransferfile`, and `makegammaspecfiles`) are the only callers of the package, and this repository holds all of them. Change a function signature or a module layout when you must.
