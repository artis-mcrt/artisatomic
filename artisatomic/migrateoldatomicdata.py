...
def main():
    inputfolder = Path('/Volumes/GoogleDrive/Shared drives/ARTIS/artis-atomic_private/artis_files_example_old')
        ...
        with path_transdata.open('w') as ftransdata:
            while line := flinelist.readline():
                ...
                if len(row) == 3:  # ion header row
                    ...
                    ftransdata.write(f'{levelid_lower:4d} {levelid_upper:4d} {A} {coll_str:9.2e} {forbidden:d}\n')
