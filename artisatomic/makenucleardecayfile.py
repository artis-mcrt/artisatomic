...
def main():
    ...
    dfmodel, _, _ = at.inputmodel.get_modeldata('/Volumes/GoogleDrive/My Drive/artis_runs/kilonova_SFHo_1d_0p2day/kilonova_SFHo_1d_0p2day_ufix_grey_20220413_cambridge')
